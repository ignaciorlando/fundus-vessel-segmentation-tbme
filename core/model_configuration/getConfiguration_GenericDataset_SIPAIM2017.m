...
function [config] = getConfiguration_GenericDataset_SIPAIM2017(datasetName, datasetPath, resultsPath, learnC, crfVersion, cValue, saveFeatures)
...
%   cValue: default C value (it will be only used if learnC=0)
    ...
    [config] = getGeneralConfiguration_SIPAIM2017(config);
