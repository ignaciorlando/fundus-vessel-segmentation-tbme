...
% SCRIPT_PREPARE_DRIVE_DATABASE
% -------------------------------------------------------------------------
% Run this code to organize DRIVE as needed in our scripts
% -------------------------------------------------------------------------
%
...
zip_filename = fullfile(input_folder, 'DRIVE.zip');

% check if the file exists
if exist(zip_filename, 'file') ~= 0
    % unzip the file
    fprintf('Unzipping DRIVE file...\n');
...
% now the input folder will be output_folder + tmp
input_folder = fullfile(output_folder, 'tmp', 'DRIVE');

%% generate DRIVE-SIPAIM
